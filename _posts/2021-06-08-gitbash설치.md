...
### 3. Git Components
<center><img src="{{site.url}}/assets/images/210608/b1.png" width="50%" height="50%"></center>

### 4. Git Editor
기본으로 사용할 IDE를 설정한다.  
취향따라 선택하면 되나 만약 IDE가 없는 경우 Use Vim (the ubiquitous text deditor) as Git
s default editor를 선택.  
<center><img src="{{site.url}}/assets/images/210608/b2.png" width="50%" height="50%"></center>  
...
<center><img src="{{site.url}}/assets/images/210608/b3.png" width="50%" height="50%"></center>  
git의 기본 repository명이 master에서 main으로 바뀌었기 때문에 후자로 커스텀 설정.
 - 브랜치 : 저장소 안의 독립적인 작업 영역

### 6. PATH environment
path(환경변수)를 설정한다.  
<center><img src="{{site.url}}/assets/images/210608/b4.png" width="50%" height="50%"></center>  
...
### 7. SSH
<center><img src="{{site.url}}/assets/images/210608/b5.png" width="50%" height="50%"></center>  

### 8. Line Ending Conversions
개행(줄바꿈) 표시 방식을 설정한다.  
<center><img src="{{site.url}}/assets/images/210608/b6.png" width="50%" height="50%"></center>  

### 9. Terminal Emulator to use with
git bash를 사용할 터미널 에뮬레이터를 설정한다.  
<center><img src="{{site.url}}/assets/images/210608/b7.png" width="50%" height="50%"></center>  
...
<center><img src="{{site.url}}/assets/images/210608/b8.png" width="50%" height="50%"></center>  
실험적인 추가기능은 선택하지 않고 진행.

### 14. 설치확인
git bash로 들어가 git --version을 입력, 아래와 같이 버전이 출력되면 설치 완료.
<center><img src="{{site.url}}/assets/images/210608/b9.png" width="50%" height="50%"></center>  
